        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
            ...
            <ul className="flex items-center gap-1">
              {navigation.map((section) => (
                ...
                >
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded-lg px-3 py-3 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-900 dark:hover:text-zinc-100"
                  >
                    {section.title}
                    <svg
                      className="h-4 w-4"
                  ...
                  {openDropdown === section.title && (
                    <div className="absolute left-0 top-full rounded-lg border border-zinc-200 bg-white shadow-lg dark:border-zinc-800 dark:bg-zinc-950">
                      <ul className="py-2">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="hidden sm:flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-900"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <button
              ...
              className="lg:hidden rounded-lg p-2 text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-900"
          ...
          <div className="lg:hidden border-t border-zinc-200 dark:border-zinc-800">
            <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="sm:hidden flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-zinc-700 transition-colors hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-900"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
